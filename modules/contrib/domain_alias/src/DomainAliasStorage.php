...
class DomainAliasStorage extends ConfigEntityStorage implements DomainAliasStorageInterface {
   ...
   *   The typed config handler.
   */
  public function __construct(EntityTypeInterface $entity_type, ConfigFactoryInterface $config_factory, UuidInterface $uuid_service, LanguageManagerInterface $language_manager, MemoryCacheInterface $memory_cache = NULL, TypedConfigManagerInterface $typed_config) {
  ...
  public static function createInstance(ContainerInterface $container, EntityTypeInterface $entity_type) {
    return new static(
      ...
      $container->get('entity.memory_cache', ContainerInterface::NULL_ON_INVALID_REFERENCE),
