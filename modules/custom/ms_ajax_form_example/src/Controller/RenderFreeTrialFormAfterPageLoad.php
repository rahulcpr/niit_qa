 ...
 */
class RenderFreeTrialFormAfterPageLoad extends ControllerBase {
    ...
    public function PopMultistepFreeFormUsingAjax($nid) {
        ...
        print_r('Sachin');
        $ajax_response->addCommand(new AppendCommand('#popmulti-div-free', $form));
