...
abstract class StepsEnum {
  ...
  public static function map($step) {
    $map = [
      self::STEP_ONE => 'Drupal\\ms_ajax_form_popup\\Step\\StepOne',
      self::STEP_TWO => 'Drupal\\ms_ajax_form_popup\\Step\\StepTwo',
      self::STEP_THREE => 'Drupal\\ms_ajax_form_popup\\Step\\StepThree',
      self::STEP_FINALIZE => 'Drupal\\ms_ajax_form_popup\\Step\\StepFinalize',
    ];
