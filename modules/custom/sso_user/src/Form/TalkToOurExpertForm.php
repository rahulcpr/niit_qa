 ...
 * Contribute form.
 */
class TalkToOurExpertForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  ...
  public function getFormId() {
    return 'sso_user_RequestACallBack_form'; 
  }
  public function __construct() {
    ...
    $this->requestACallBack_form = 'RequestACallBackForm';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $node_id = NULL) {
    ...
    $form['web_container']['enqry_crsspndnc_city'] = [
        HASH_TYPE => TEXTFIELD,
        HASH_REQUIRED => TRUE,
        HASH_TITLE => t('City'),
    ...
    $form['web_container']['enqry_crsspndnc_state'] = [
        HASH_TYPE => TEXTFIELD,
    ...
    if($camp == 'NMN5G'){
      ...
      $form['web_container']['prfrd_cntr'] = [
        ...
        '#attributes' => ['class' => ['form-control'], 'id' => 'edit-prfrd-cntr'],
  ...
  public function AjaxCallBackTalkToOurExpert(array &$form, FormStateInterface $form_state,$form_id) {
       ...
       //    multistep_postapidate('I', $data);
          ...
          $ajax_response->addCommand(new HtmlCommand('.modal-content.msg-succ','<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
          ...
          $ajax_response->addCommand(new InvokeCommand(NULL, 'talkTest', ['']));
        }
