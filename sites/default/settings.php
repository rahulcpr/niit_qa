 ...
 * @endcode
 */
$settings['hash_salt'] = '6NXF_UXGjVAi3G_RvmribAw4hd_7pFq7q49fHQlyBiqtXqCKINyq0w5zJPGx-OGOGI-xxiJMgQ';
...
/*Reverse proxy settings start*/
$settings['reverse_proxy'] = TRUE;
$settings['reverse_proxy_addresses'] = array($_SERVER['X_FORWARDED_HOST']);
/*Reverse proxy settings end*/
/**
 * Page caching:
 *
 ...
 */
 $settings['file_public_base_url'] = 'http://localhost:8080/qa/sites/default/files';
...
$settings['trusted_host_patterns'] = array(
   '^https://www\.drupal-dev.niit\.com/india$',
);
 */
...
if (file_exists($app_root . '/' . $site_path . '/constants.php')) {
  include $app_root . '/' . $site_path . '/constants.php';
}
/**
    $setMemCache = 0; 
    ...
    if($setMemCache == 0) { 
**/
    /*$memcache_ip = isset($_ENV['memcache_server']) ? $_ENV['memcache_server'] : '127.0.0.1:11211'; 
    $settings['cache']['default'] = 'cache.backend.memcache_storage'; 
    $settings['memcache_storage']['key_prefix'] = isset($_ENV['memcache_prefix']) ? $_ENV['memcache_prefix'] : 'drupal_'; 
    $settings['memcache_storage']['memcached_servers'] =   [$memcache_ip => 'default']; 
...
/*$databases['default']['default'] = array (
    ...
    'username' => $_ENV['DRUPAL_USER'],
    'password' => $_ENV['DRUPAL_PASS'],
    'prefix' => 'd8_',
...
$config_directories['sync'] = 'sites/default/files/config_VMiUYxP2D8G6GrZnTxVtLNtnLTMFRhrGPCMQBm5SPqdupDKqxrAplZVNaHpZriCcqhBIHUG79g/sync';
