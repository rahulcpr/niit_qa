    ...
    ResponsiveTabs.prototype._loadElements = function () {
        ...
        jQuery('li', $ul).each(function () {
            ...
            if (!isExcluded) {
                ...
                $accordionTab = jQuery('<div></div>').insertBefore($panel);
                $accordionAnchor = jQuery('<a></a>').attr('href', panelSelector).html($anchor.html()).appendTo($accordionTab);
...
jQuery(function () {
    jQuery('#horizontalTab2').responsiveTabs({
        rotate: false,
        startCollapsed: 'accordion',
        collapsible: 'accordion',
        setHash: false,
